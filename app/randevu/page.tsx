...
export default function Booking() {
  ...
  return <div className="booking-page">
    ...
    <form onSubmit={submit}><div className="booking-main">
      ...
      <section className="booking-stage details-stage"><div className="stage-title"><span>04</span><div><h2>İletişim bilgileriniz</h2><p>Randevunuzu onaylamak için size ulaşalım.</p></div></div>{error&&<p className="form-error">{error}</p>}<div className="detail-fields"><label>AD SOYAD<input name="name" required autoComplete="name" placeholder="Adınız ve soyadınız"/></label><label>TELEFON<input name="phone" required type="tel" autoComplete="tel" placeholder="0531 000 00 00"/></label><label className="full">E-POSTA <small>İSTEĞE BAĞLI · TALEP ÖZETİ İÇİN</small><input name="email" type="email" autoComplete="email" placeholder="ornek@email.com"/></label><label className="full">NOTUNUZ<textarea name="note" rows={3} placeholder="Eklemek istediğiniz bir not…"/></label></div></section>
